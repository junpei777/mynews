            ...
            <div class="col-md-8 mx-auto">
               ...
               　　　<div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea class="form-control" name="introduction" rows="1">{{ $profile_form->introduction }}</textarea>
                        </div>
                    </div>
                　　 <div class="form-group row">
                    ...
                    <div class="col-md-4 mx-auto">
                        ...
                        <ul class="list-group">
                            @if ($profile_form->histories != NULL)
                                @foreach ($profile_form->histories as $history2s)
                                    <li class="list-group-item">{{ $history2s->edited_at }}</li>
                                @endforeach
                            @endif
                        </ul>
                    </div>
